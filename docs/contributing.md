...
Contributions are welcome. `go-ruby-etcd/etcd` is built to a small set of
...
The library is in [`github.com/go-ruby-etcd/etcd`](https://github.com/go-ruby-etcd/etcd).
This documentation site is in [`github.com/go-ruby-etcd/docs`](https://github.com/go-ruby-etcd/docs).
