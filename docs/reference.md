...
The public API lives at the module root (`github.com/go-ruby-etcd/etcd`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `etcd`, while the surface follows
...
```go
import "github.com/go-ruby-etcd/etcd"
```
...
- **[pkg.go.dev/github.com/go-ruby-etcd/etcd](https://pkg.go.dev/github.com/go-ruby-etcd/etcd)**

The module's [README](https://github.com/go-ruby-etcd/etcd#readme) carries worked
